...
final class StartMenuWindow: NSObject, NSWindowDelegate {
    ...
    private func render() {
        ...
        let stack = NSStackView(views: virtualMachineRunning
            ? [headingStack, automaticStartSection, launchButton, runningActions] + settingsSections + [resetSection]
            : [headingStack] + settingsSections + [automaticStartSection, launchButton, resetSection])
